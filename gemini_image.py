...
def generate_image(prompt: str, output_path: str = "generated_image.png") -> str:
    ...
    style = "full body shot, anime style, High quality, Flat colour anime style image showing, high quality image, 8k, ultra UHD, clear image, sharp lines, highly detailed image, realistic anatomy, perfectly realistic hands, anime nose, realistic leg length"
